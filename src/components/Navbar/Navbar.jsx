    ...
    <>
      ...
      <div className="h-[83px] px-4 flex items-center justify-between bg-[var(--ui-color-light)]">
        ...
        <div className="flex items-center justify-start">
          <img src="/images/nav/nasm-logo-blue.svg" alt="NASM Logo" className="w-[5.5rem]"/>
          <img src="/images/nav/nasm-menu.png" alt="Menu" onClick={menuToggle} className="w-[3rem] mx-4"/>
          <a href="tel:+18004606276">
            <img src="/images/nav/nasm-mobile.png" alt="Phone" className="w-[2rem]"/>
          </a>
        </div>
        ...
        <div className="flex items-center justify-end">
          ...
          <a href="https://shop.nasm.org/cart">
            <img src="/images/nav/nasm-shopping-cart.png" alt="Cart" className="w-[2.5rem] ml-4 mb-2"/>
          </a>
        </div>
      </div>
    </>
